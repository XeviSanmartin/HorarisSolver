...
class Curs(BaseModel):
    ...
    necessita_aula_gran: bool = Field(
        default=True,
        description='Si és cert (per defecte), les classes de grup sencer només poden anar a aules grans. Si és fals, el grup té pocs alumnes i hi cap a qualsevol aula.')
...
class Aula(BaseModel):
    ...
    aula_gran: bool = Field(default=True, description="Si és cert (per defecte), hi cap un grup sencer. Si és fals, és una aula petita: només hi caben desdoblaments (subgrups 1 i 2) o grups sencers que no necessiten aula gran. Substitueix l'antic `nomes_subgrups`.")
